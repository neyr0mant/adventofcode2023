...
for i in open("data.txt"):
    ...
    for j in list_game:
        ...
        if key_1.isdigit():
            if dict_data_game[index_game].get(key_2):
                dict_data_game[index_game][key_2].append(int(key_1))
            else:
                dict_data_game[index_game].update({key_2: [int(key_1)]})
        else:
            if dict_data_game[index_game].get(key_1):
                dict_data_game[index_game][key_1].append(int(key_2))
            else:
